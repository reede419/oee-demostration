                  ...
                  <div class="factory-potential">
                    ...
                    <div class="hide-factory">
                      <div class="potential-value">
                        ...
                        <p class="hide-factory-value">{{hiddenFactoryValue.toLocaleString()}} <span>&#8364;</span></p>
                      </div>
                      <svg width="156" height="156" viewBox="0 0 156 156" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M144.949 144.832H138.232V116.644C139.575 115.464 140.424 113.736 140.424 111.812C140.424 108.264 137.538 105.378 133.99 105.378H120.573L118.501 72.23C118.434 71.1491 117.537 70.3072 116.455 70.3072H107.687C106.604 70.3072 105.708 71.1491 105.64 72.23L103.568 105.378H98.6538L96.582 72.23C96.5144 71.1491 95.6181 70.3072 94.5353 70.3072H85.7678C84.685 70.3072 83.7886 71.1491 83.7211 72.23L81.6493 105.378H76.7348L74.6629 72.23C74.5954 71.1491 73.6991 70.3072 72.6162 70.3072H63.8488C62.7659 70.3072 61.8696 71.1491 61.8021 72.23L59.7302 105.378H54.0181L52.7477 48.2014C52.7231 47.0869 51.8123 46.1963 50.6975 46.1963H37.546C36.4312 46.1963 35.5203 47.0869 35.4957 48.2014L34.0304 114.146H17.8183C14.2702 114.146 11.3837 117.032 11.3837 120.58C11.3837 122.504 12.2333 124.232 13.5756 125.412V144.832H9.05078C7.9182 144.832 7 145.75 7 146.883C7 148.015 7.9182 148.934 9.05078 148.934H144.949C146.082 148.934 147 148.015 147 146.883C147 145.75 146.082 144.832 144.949 144.832ZM33.8349 122.913L28 122.913C26.8674 122.913 26 123.831 26 124.964C26 126.096 26.8674 127.015 28 127.015H33.7438L33.3479 144.832H17.6772V127.011C17.7242 127.012 17.771 127.015 17.8183 127.015C18.9509 127.015 19.8691 126.096 19.8691 124.964C19.8691 123.831 18.9509 122.913 17.8183 122.913C16.5318 122.913 15.4853 121.866 15.4853 120.58C15.4853 119.294 16.532 118.247 17.8183 118.247H33.9385L33.8349 122.913ZM109.613 74.4088H114.528L116.463 105.378H107.678L109.613 74.4088ZM87.6941 74.4088H92.6086L94.5443 105.378H85.7588L87.6941 74.4088ZM65.7751 74.4088H70.6896L72.625 105.378H63.8395L65.7751 74.4088ZM42.0708 144.832H37.4508L39.5511 50.2976H48.6913L49.9155 105.378H46.3135C42.7654 105.378 39.8787 108.264 39.8787 111.812C39.8787 113.736 40.7282 115.464 42.0708 116.644V144.832ZM133.99 114.145H129.606C128.474 114.145 127.555 115.063 127.555 116.196C127.555 117.329 128.474 118.247 129.606 118.247H133.99C134.037 118.247 134.084 118.244 134.131 118.243V144.832H46.1721V118.243C46.2191 118.244 46.2659 118.247 46.3132 118.247L99 118.243C100.133 118.243 101 117.329 101 116.196C101 115.063 100.133 114.145 99 114.145H46.3132C45.0267 114.145 43.98 113.099 43.98 111.812C43.98 110.526 45.0267 109.479 46.3132 109.479H133.99C135.276 109.479 136.323 110.526 136.323 111.812C136.323 113.099 135.276 114.145 133.99 114.145Z" fill="#707381"/>
                        <path d="M60.0508 128.196C58.9182 128.196 58 129.114 58 130.247V134.631C58 135.763 58.9182 136.682 60.0508 136.682C61.1834 136.682 62.1016 135.763 62.1016 134.631V130.247C62.1016 129.114 61.1834 128.196 60.0508 128.196Z" fill="#707381"/>
                        <path d="M72.6367 128.196C71.5041 128.196 70.5859 129.114 70.5859 130.247V134.631C70.5859 135.763 71.5041 136.682 72.6367 136.682C73.7693 136.682 74.6875 135.763 74.6875 134.631V130.247C74.6875 129.114 73.7693 128.196 72.6367 128.196Z" fill="#707381"/>
                        <path d="M84.6367 128.196C83.5041 128.196 82.5859 129.114 82.5859 130.247V134.631C82.5859 135.763 83.5041 136.682 84.6367 136.682C85.7693 136.682 86.6875 135.763 86.6875 134.631V130.247C86.6875 129.114 85.7693 128.196 84.6367 128.196Z" fill="#707381"/>
                        <path d="M96.6367 128.196C95.5041 128.196 94.5859 129.114 94.5859 130.247V134.631C94.5859 135.763 95.5041 136.682 96.6367 136.682C97.7693 136.682 98.6875 135.763 98.6875 134.631V130.247C98.6875 129.114 97.7693 128.196 96.6367 128.196Z" fill="#707381"/>
                        <path d="M108.637 128.196C107.504 128.196 106.586 129.114 106.586 130.247V134.631C106.586 135.763 107.504 136.682 108.637 136.682C109.769 136.682 110.688 135.763 110.688 134.631V130.247C110.688 129.114 109.769 128.196 108.637 128.196Z" fill="#707381"/>
                        <path d="M120.637 128.196C119.504 128.196 118.586 129.114 118.586 130.247V134.631C118.586 135.763 119.504 136.682 120.637 136.682C121.769 136.682 122.688 135.763 122.688 134.631V130.247C122.688 129.114 121.769 128.196 120.637 128.196Z" fill="#707381"/>
                        <path d="M99.6875 43.8125H98.1953V37.75C98.1953 35.4026 96.2927 33.5 93.9453 33.5H86.6797C84.3323 33.5 82.4297 35.4026 82.4297 37.75V43.8125H80.9375C80.1428 43.8125 79.5 44.4553 79.5 45.25V56.5C79.5 57.2947 80.1428 57.9375 80.9375 57.9375H99.6875C100.482 57.9375 101.125 57.2947 101.125 56.5V45.25C101.125 44.4553 100.482 43.8125 99.6875 43.8125ZM85.5391 37.75C85.5391 37.1209 86.0506 36.6094 86.6797 36.6094H93.9453C94.5744 36.6094 95.0859 37.1209 95.0859 37.75V43.8125H85.5391V37.75ZM98.0156 54.8281H82.6094V46.9219H98.0156V54.8281Z" fill="#707381" stroke="#707381"/>
                      </svg>
                    </div>
                  </div>
                  <div class="potential-line dont-painted-line">
                    <div class="potential-line painted-line" :style="{width: currentFactoryWidth + '%'}"></div>
                  </div>
              ...
              <v-row class="input-block">
                <v-col cols="12">
                  <v-row class="block-input">
                    <v-col xl="3" lg="3" md="4" v-for="input of inputs" :key="input.id">
...
export default {
  ...
  data: () => ({
    ...
    inputs: [
      {id: 'planned-hours', currentVal: '8760', minVal: '0', maxVal: '1000', suffix: 'год', label: 'Заплановані години', class: ''},
      {id: 'max-productivity', currentVal: '50', minVal: '0', maxVal: '1000', suffix: 'од/год', label: 'Макс. прод. / год.', class: ''},
      {id: 'price-per-item', currentVal: '0.6', minVal: '0', maxVal: '1000', suffix: '€', label: 'Ціна / одиниця', class: ''},
      {id: 'cost', currentVal: '0.35', minVal: '0', maxVal: '1000', suffix: '€', label: 'Пер. вартість / од.', class: ''},
      {id: 'direct-maintenance-costs', currentVal: '9469', minVal: '0', maxVal: '1000', suffix: '€', label: 'Прямі витрати на ТО', class: ''},
      {id: 'amortizations', currentVal: '15000', minVal: '0', maxVal: '1000', suffix: '€', label: 'Амортизація', class: ''},
      {id: 'other-fixed-costs', currentVal: '30000', minVal: '0', maxVal: '1000', suffix: '€', label: 'Інші постійні витрати', class: ''},
    ]
  }),
  mounted() {
  ...
  computed: {
    getPlannedHours() {
      let plannedHours = this.inputs.find(
      (el) => el.id == "planned-hours"
      );
    ...
    getPricePerItem() {
      let pricePerItem = this.inputs.find(
        (el) => el.id == "price-per-item"
      );
      return pricePerItem.currentVal;
    },
    getCost() {
      let cost = this.inputs.find(
        (el) => el.id == "cost"
      );
    ...
    getAmortizations() {
      let amortizations = this.inputs.find(
        (el) => el.id == "amortizations"
      );
  ...
  methods: {
    ...
    getCurrentFactoryValue(
      ...
      this.currentFactoryValue = Math.ceil(margaPerYearCurrency - +directMaintenanceCosts - +amortizations - +otherFixedCosts)
      this.hiddenFactoryValue = Math.ceil(margaPerYearTeoretical - +directMaintenanceCosts - +amortizations - +otherFixedCosts)

      let currentWidth = (this.currentFactoryValue * 100) / this.hiddenFactoryValue

      this.currentFactoryWidth = currentWidth > 0 && currentWidth < 100
...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: local('Manrope-Regular'), url(~@/assets/fonts/Manrope-VariableFont_wght.ttf) format('truetype');
}
...
@media(min-width: 2000px) {
  ...
  .profit-value .profit, .potential-value .potential {
    font-size: 32px;
  }
...
@media(max-width: 1263px) {
  ...
  .factory-potential .current-factory p, .factory-potential .hide-factory p {
    font-size: 18px;
  }
  .current-hide-factory span {
    font-size: 16px;
